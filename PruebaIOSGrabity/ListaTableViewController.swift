...
class ListaTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier(textCellIdentifier, forIndexPath: indexPath) as! ListaCellController
        ...
        self.animationforpostiondeslat(cell,ajuste_y: 90.0,pfinal: 950.0)
        return cell
    }
    func animationforpostiondeslat(ob : NSObject, ajuste_y:CGFloat, pfinal:CGFloat)
    {
        ...
        objectcc.frame.origin = CGPoint(x: pfinal, y: osurface.origin.y)
